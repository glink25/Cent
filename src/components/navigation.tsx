...
export default function Navigation() {
	...
	return createPortal(
		...
		>
			...
			<button
				type="button"
				className={`w-14 h-14 sm:w-10 sm:h-10 cursor-pointer flex items-center justify-center rounded-full shadow-md m-2  transition-all hover:bg-gray-200 active:bg-gray-300 ${currentTab === "/search" ? "bg-gray-300" : "bg-white"
					}`}
			...
			<div className="flex items-center rounded-full p-1 bg-white w-56 h-14 m-2 shadow-md sm:flex-col sm:w-10 sm:h-50 sm:-order-1">
				<button
					type="button"
					className={`flex-1 h-full w-full transition rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-200 active:bg-gray-300 ${currentTab === "/" ? "bg-gray-300" : ""
						}`}
					onClick={() => switchTab("/")}
				>
					<i className="icon-[mdi--format-align-center]"></i>
				</button>
				...
				>
					<i className="icon-[mdi--add] text-[white]"></i>
				</button>

				<button
					type="button"
					className={`flex-1 h-full w-full transition-all rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-200 active:bg-gray-300 ${currentTab === "/stat" ? "bg-gray-300" : ""
						}`}
