...
export default function BookGuide() {
    ...
    return (
        ...
        >
            <Dialog.Portal>
                <Dialog.Overlay className="fixed z-[1000] inset-0 bg-black/50 data-[state=open]:animate-overlay-show"></Dialog.Overlay>
                <Dialog.Content>
                    <VisuallyHidden.Root>
                    ...
                    <div className="fixed z-[1001] top-0 left-0 w-full h-full flex justify-center items-center pointer-events-none">
                        <Dialog.Content
                            className={cn(
